...
function buildProfileButtonPreset(self, profile, page, button) {
    ...
    const label = hasContent
        ...
        : "";
    const style = buildButtonStyle(label, baseBg);
    const previewStyle = buildButtonStyle(label, baseBg);
    const actionOptions = {
